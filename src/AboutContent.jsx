  ...
  return (
    <>
        <div className="aboutcontent">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apart from my technical skills, I have a strong passion for chess, which has been a significant part of my life. Playing chess has not only been a recreational activity for me but also a way to sharpen my problem-solving abilities and enhance my strategic thinking. The game has taught me the importance of planning, patience, and adaptability—qualities that I apply to both my personal life and professional work.<br></br><br></br>

            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;As a fresher stepping into the tech industry, I am excited about the opportunities ahead. I am eager to learn, collaborate, and contribute to projects that challenge my abilities and push me to grow. Whether it’s working on creative designs or complex coding problems, I bring enthusiasm, attention to detail, and a commitment to excellence in everything I do. I look forward to working in a dynamic environment where I can continue to expand my skills and contribute to innovative solutions.
            </p>
        </div>
    </>
  )
